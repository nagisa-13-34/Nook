...
export const meta = { tags: ['channels'], requireCredential: true, kind: 'read:channels' } as const; export const paramDef = { type: 'object', properties: { channelId: { type: 'string', format: 'misskey:id' }, sessionId: { type: 'string', minLength: 16, maxLength: 64 } }, required: ['channelId','sessionId'] } as const;
