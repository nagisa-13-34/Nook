...
const ja = {
	community: 'ネスト', channels: 'チャンネル', announcements: 'お知らせ', events: 'イベント', members: 'メンバー', bots: 'Bot', admin: '管理', administrator: '管理者', info: '情報',
	...
	communityProfile: 'ネストプロフィール', communityProfileHint: 'この名前と画像はこのネスト内だけで使われます。', communityDisplayName: 'ネストでの名前', communityAvatar: 'ネストでのプロフィール画像', changeAvatar: '画像を変更', resetAvatar: '通常プロフィールの画像を使う', profileSaved: 'ネストプロフィールを保存しました', upload: 'アップロード', fromDrive: 'Driveから選択',
	communityInfo: 'ネスト情報', editCommunityInfo: '名前・説明・画像を編集', communityInfoHint: 'ネスト名、説明、画像などの基本情報を編集します。',
	...
	addRule: 'ルールを追加', noRules: 'ルールはまだありません。', inviteCommunity: 'ネストに招待', inviteExpires: '有効期限', never: '期限なし', oneHour: '1時間', oneDay: '1日', oneWeek: '7日', oneMonth: '30日', maxUses: '利用回数', unlimited: '無制限', createInvite: '招待リンクを作成', revoke: '無効化',
	...
	deleteCommunity: 'ネストを削除', deleteCommunityHint: 'ネストとNook内の関連データを完全に削除します。この操作は取り消せません。', deleteCommunityConfirm: '本当にこのネストを完全に削除しますか？', typeCommunityName: '確認のためネスト名を入力',
};

const en: typeof ja = {
	community: 'Nest', channels: 'Channels', announcements: 'Announcements', events: 'Events', members: 'Members', bots: 'Bots', admin: 'Admin', administrator: 'Administrator', info: 'Info',
	...
	communityProfile: 'Nest profile', communityProfileHint: 'This name and image are used only inside this Nest.', communityDisplayName: 'Name in this Nest', communityAvatar: 'Nest profile image', changeAvatar: 'Change image', resetAvatar: 'Use account profile image', profileSaved: 'Nest profile saved', upload: 'Upload', fromDrive: 'Choose from Drive',
	communityInfo: 'Nest info', editCommunityInfo: 'Edit name, description, and image', communityInfoHint: 'Edit the Nest name, description, image, and other basic information.',
	...
	ageMode: 'Age mode', ageModeHint: 'Choose which age groups may join. Accounts whose age cannot be verified cannot join minors-only or adults-only Nests.', ageModeMinorsOnly: 'Minors only', ageModeMixed: 'All ages', ageModeAdultsOnly: 'Adults only', ageModeConflict: 'This age mode cannot be applied because one or more current members do not match it.',
	settingsSaved: 'Settings saved', settingsSaveFailed: 'Could not save settings',
	addRule: 'Add rule', noRules: 'No rules yet.', inviteCommunity: 'Invite to Nest', inviteExpires: 'Expires', never: 'Never', oneHour: '1 hour', oneDay: '1 day', oneWeek: '7 days', oneMonth: '30 days', maxUses: 'Uses', unlimited: 'Unlimited', createInvite: 'Create invite link', revoke: 'Revoke',
	...
	deleteCommunity: 'Delete Nest', deleteCommunityHint: 'Permanently delete this Nest and its related Nook data. This cannot be undone.', deleteCommunityConfirm: 'Permanently delete this Nest?', typeCommunityName: 'Type the Nest name to confirm',
};
