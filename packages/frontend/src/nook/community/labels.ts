...
const ja = {
	...
	communityProfile: 'コミュニティプロフィール', communityProfileHint: 'この名前と画像はこのコミュニティ内だけで使われます。', communityDisplayName: 'コミュニティでの名前', communityAvatar: 'コミュニティでのプロフィール画像', changeAvatar: '画像を変更', resetAvatar: '通常プロフィールの画像を使う', profileSaved: 'コミュニティプロフィールを保存しました', upload: 'アップロード', fromDrive: 'Driveから選択',
	communityInfo: 'コミュニティ情報', editCommunityInfo: '名前・説明・画像を編集', communityInfoHint: 'コミュニティ名、説明、画像などの基本情報を編集します。',
...
const en: typeof ja = {
	...
	communityProfile: 'Community profile', communityProfileHint: 'This name and image are used only inside this community.', communityDisplayName: 'Name in this community', communityAvatar: 'Community profile image', changeAvatar: 'Change image', resetAvatar: 'Use account profile image', profileSaved: 'Community profile saved', upload: 'Upload', fromDrive: 'Choose from Drive',
	communityInfo: 'Community info', editCommunityInfo: 'Edit name, description, and image', communityInfoHint: 'Edit the community name, description, image, and other basic information.',
