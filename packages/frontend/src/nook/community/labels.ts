...
const ja = {
	...
	joinMode: '参加方式', discoverable: '検索・発見に表示する', ageMode: '年齢モード', ageModeHint: '参加できる年齢層を指定します。年齢を確認できないアカウントは「未成年のみ」「成人のみ」には参加できません。', ageModeMinorsOnly: '未成年のみ', ageModeMixed: '全年齢', ageModeAdultsOnly: '成人のみ', ageModeConflict: '現在のメンバーに、この年齢モードの条件に合わないアカウントがいるため変更できません。', settingsSaved: '設定を保存しました', settingsSaveFailed: '設定を保存できませんでした',
};
const en: typeof ja = {
	...
	joinMode: 'Join mode', discoverable: 'Show in discovery', ageMode: 'Age mode', ageModeHint: 'Choose which age groups may join. Accounts whose age cannot be verified cannot join minors-only or adults-only Communities.', ageModeMinorsOnly: 'Minors only', ageModeMixed: 'All ages', ageModeAdultsOnly: 'Adults only', ageModeConflict: 'This age mode cannot be applied because one or more current members do not match it.', settingsSaved: 'Settings saved', settingsSaveFailed: 'Could not save settings',
};
