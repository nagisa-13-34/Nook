...
const nookLocale = lang === 'ja-JP'
	? {
		...
		nookVideo: '動画',
		nookVideoDescription: 'Nookの動画を楽しむための専用スペース',
		nookShorts: 'スパーク',
		nookShortsDescription: '縦型の短い動画をテンポよく見る',
		nookVideos: 'シアター',
		nookVideosDescription: '通常の動画をゆっくり楽しむ',
		nookFollowing: 'フォロー中',
		nookDiscover: 'みつける',
		nookSearchDiscover: '検索・みつける',
		nookDiscoverUsers: 'おすすめユーザー',
		nookMedia: 'メディア',
	...
	: {
		...
		nookVideo: 'Video',
		nookVideoDescription: 'A dedicated space for videos on Nook',
		nookShorts: 'Spark',
		nookShortsDescription: 'Watch short portrait videos at a quick pace',
		nookVideos: 'Theater',
		nookVideosDescription: 'Sit back and enjoy regular videos',
		nookFollowing: 'Following',
		nookDiscover: 'Discover',
		nookSearchDiscover: 'Search & Discover',
		nookDiscoverUsers: 'Suggested users',
		nookMedia: 'Media',
